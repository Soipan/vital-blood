...
<?php 
	if (isset($_POST['apply'])){
		...
		$sql = "INSERT INTO blood_request(hospital_name,official_name,official_position,email,type,amount,status)VALUES('$hospital','$name','$position','$email','$type','$amount','$status')";
