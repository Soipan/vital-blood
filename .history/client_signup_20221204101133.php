   ...
   $result = mysqli_query($conn, $select);
    ...
    if($pass != $cpass){
        $error[] = 'password not matched!';
         ...
         $insert = "INSERT INTO blood_request (hospital, name,  official, email, password, blood_type,blood_amount) VALUES('$hospital','$official_name','$official_position','$email', '$pass','$blood_type','$blood_amount')";
