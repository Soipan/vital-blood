   ...
   $result = mysqli_query($conn, $select);
    ...
    if($pass != $cpass){
        $error[] = 'password not matched!';
         ...
         $insert = "INSERT INTO blood_request (hospital_name, official_name,  official_position, email, password, blood_type,blood_amount) VALUES('$hospital','$official_name','$official','$email', '$pass','$blood_type','$blood_amount')";
...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      ?>
       <input type="text" name="hospital" required placeholder="enter the hospital name">
      <input type="text" name="name" required placeholder="enter your name">
      <input type="text" name="official" required placeholder="enter the hospital position">
