...
.hero-btn:hover{
 ...
 <div class="container event">
              ...
              <div class="offset-sm-1 col-sm-5">
                  ...
                  <div class="event-content">
                      <h6>Business Mastery Event</h6>
                        <span>Blood drive held at <br> Aga Khan Hospital for baby Naya.<br> Blood type required is AB </span><br><br>
          ...
          <section class="cta">
        <h1>Sign Up For a Blood Drive</h1>
        <a href="donor_signup.php" class="hero-btn"> Sign Up</a>
     </section>
