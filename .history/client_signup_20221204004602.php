...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <select name="month">
         ...
         <option value="december">february</option>
         <option value="january">march</option>
         <option value="december">april</option>
         <option value="december">may</option>
         <option value="december">june</option>
         <option value="december">july</option>
         <option value="december">august</option>
         <option value="december">september</option>
         <option value="december">octber</option>
