...
.banner{
    width: 100%;
    height: 100vh;
    background-image: linear-gradient(rgba(0,0,0,0.30),rgba(0,0,0,0.30)),url(photos/about.jpg);
 ...
 <div class="container event">
          <div class="row text-center justify-content-center">
              ...
              <div class="offset-sm-1 col-sm-5">
                  <img src="care2.jpg" class="img-fluid" alt="">
                  <div class="event-content">
                      <h6>Aga Khan Blood Drive </h6>
                        <span>Blood drive held on <b> </b>18TH DECEMBER 2022</b> <br> Aga Khan Hospital for cancer patients undergoing treatment.<br> Blood type required is of all types. </span><br><br>
                      <a href="donor_signup.php">Join Us</a>
                  </div>
              </div>

              <div class="offset-sm-1 col-sm-5">
                <img src="kids.jpg" class="img-fluid" alt="">
                <div class="event-content">
                    <h6>Nairobi Women's Hospital Blood Drive </h6>
                    <span>Blood drive held on <b> </b>18TH JANUARY 2023</b> <br> Nairobi Women's Hospital for babies and kids receiving treatment from various illnesses.<br> Blood type required is all types so everyone is welcome </span><br><br>
                    <a href="donor_signup.php">Join Us</a>
                </div>
            </div>
          </div>
